...
function Popup(props) {
  ...
  const reqchange=(e)=>{
    ...
    console.log("value") 
    console.log(value)
    let ans = `Issue with Order Id ${props.sub}` 
    setsubject(ans)
      ...
      >
        ...
        <Form.Group className='mx-3 my-2' >
             <Form method='POST' onSubmit={handleresent}>
              ...
              <Form.Control type="text"   placeholder="Subject" defaultValue={`Issue with Order Id ${props.sub}`} name='subject' onChange={reqchange}/> 
